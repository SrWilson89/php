...
class Router {
    ...
    private function crearRutas() {
        $this->rutas = [
            ...
            [
                "pattern" => "equipos_de_futbol",
                "metodo" => "GET",
                "controller" => "EquiposController",
                "accion" => "index"
            ],
            [
                "pattern" => "equipos_de_futbol/:idEquipo",
                "metodo" => "GET",
                "controller" => "EquiposController",
                "accion" => "getEquipo"
            ],
            ...
            [
                "pattern" => "equipos_de_futbol/ciudad/:ciudad",
                "metodo" => "GET",
                "controller" => "EquiposController",
                "accion" => "getCiudad"
            ],
            [
                ...
                "metodo" => "GET",
                "controller" => "EquiposController",
                "accion" => "getEquipoByDivision"
            ],
            [
                "pattern" => "ciudad/:ciudad",
                "metodo" => "GET",
                "controller" => "EquiposController",
                "accion" => "getEquipoByCiudad"
            ],
            [
                "pattern" => "total/:id",
                "metodo" => "GET",
                "controller" => "EquiposController",
                "accion" => "getjugadoresTotal"
            ]
        ];
    }
