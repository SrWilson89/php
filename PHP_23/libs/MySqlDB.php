...
class MySqlDB {
    //en dbname es donde ira el nombre de la base de datos
    const DNS = "mysql:host=localhost;dbname=netvideo;port=3306;charset=UTF8";
    const USUARIO = 'root';
    const PASS = '';
                ...
                case 23000:
                    switch ($e->errorInfo[1]) {
                        case 1451:
                            ...
                            break;
                        case 1062:
                            throw new MySqlDBException('Id duplicado.');
                            break;
                        default:
                            throw new MySqlDBException($e->getMessage());
                    }
