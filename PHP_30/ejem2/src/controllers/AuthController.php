...
class AuthController {
    ...
    /**
     * Da de alta a un usuario y guarda el password encryptado.
     * 
     * Recibe un json como el siguiente ejemplo:
     * ```
     * {
     *      "nombre" : "fermin",
     ...
     * 
     * Recibe un json con la siguente estructura:
     * ```
     * {
     *      "email" : "fermil@email.com",
     *      "password" : "123456"
     * }
     * ``` 
     * Devuelve un json con el siguiente formato:
